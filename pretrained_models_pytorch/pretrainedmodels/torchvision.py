...
__all__ = [
    ...
    'vgg19_bn', 'vgg19', 'googlenet','shufflenet_v2_x0_5','shufflenet_v2_x1_0'
]
...
def shufflenet_v2_x0_5(num_classes=1000, pretrained='imagenet'):
    """VGG 19-layer model (configuration 'E') with batch normalization
    """
    model = models.shufflenet_v2_x0_5(pretrained=False)
    if pretrained is not None:
        settings = pretrained_settings['shufflenet_v2_x0_5'][pretrained]
        model = load_pretrained(model, num_classes, settings)
    return model

def shufflenet_v2_x1_0(num_classes=1000, pretrained='imagenet'):
    """VGG 19-layer model (configuration 'E') with batch normalization
    """
    model = models.shufflenet_v2_x1_0(pretrained=False)
    if pretrained is not None:
        settings = pretrained_settings['shufflenet_v2_x1_0'][pretrained]
        model = load_pretrained(model, num_classes, settings)
    return model
